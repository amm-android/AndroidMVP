...
public class WirelessHelper {
    ...
    private static WirelessHelper wirelessHelper;

    public static WirelessHelper get() {
        if (wirelessHelper == null) {
            wirelessHelper = new WirelessHelper();
        }
        return wirelessHelper;
    }
    ...
    private WirelessHelper() {
        this.wifiManager = (WifiManager) AppUtils.getContext().getApplicationContext().getSystemService(Context.WIFI_SERVICE);
        this.wifiInfo = wifiManager.getConnectionInfo();
        connectivityManager = (ConnectivityManager) AppUtils.getContext().getSystemService(Context.CONNECTIVITY_SERVICE);
    }
